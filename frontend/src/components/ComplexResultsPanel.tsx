      ...
      <section className="overflow-hidden rounded-3xl border border-amber-200 bg-white shadow-sm">
        <div className="border-b border-amber-200 bg-amber-50 px-5 py-4">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="rounded-full border border-amber-300 bg-white px-2 py-1 text-[10px] font-bold uppercase tracking-wider text-amber-800">
              not a trusted complex result
            </span>
          </div>
          <h2 className="mt-2 text-lg font-bold tracking-tight text-slate-950">
            KRAS G12C target structure · 6OIM
          </h2>
          <p className="mt-1 max-w-3xl text-xs leading-relaxed text-amber-900">
            The 3D view is available for orientation and residue inspection. This run
            has no WT-versus-mutant Tamarind artifacts, so the viewer must not be read
            as evidence that the candidate binds or passes the promotion gates.
          </p>
        </div>

        <div className="grid gap-5 p-5 xl:grid-cols-[1.35fr_1fr] xl:items-stretch">
          <div className="h-[380px] overflow-hidden rounded-2xl border border-slate-700 bg-slate-900">
            <ProteinViewer
              pdbData={fallbackPdbData}
          ...
          <div className="flex flex-col justify-between rounded-2xl border border-slate-200 bg-slate-50 p-4">
            <div>
              <h3 className="text-sm font-bold text-slate-950">What this view shows</h3>
              <ul className="mt-3 space-y-2 text-xs leading-relaxed text-slate-600">
                <li>• Gray cartoon: the KRAS G12C reference protein.</li>
                <li>• Amber/cyan/red badges: residues in the design specification.</li>
                <li>• Green pocket reference: the crystallized ligand, when present.</li>
              </ul>
            </div>
            <div className="mt-5 rounded-xl border border-amber-200 bg-white p-3 text-[11px] leading-relaxed text-amber-900">
              <strong>Evidence boundary:</strong> run Tamarind WT and resistance
              complex jobs before treating a binder pose or interface score as a
              promotion decision.
            </div>
          </div>
        </div>
