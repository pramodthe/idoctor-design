...
If Proto produced only fixtures, we **do not claim a new biological design**. We present Track A + B and say the design node is mocked.
...
4. **(0:45–1:05)** Design pane. “Proto proposed ten binders. The critic killed eight — too similar to a known structure, or only good on wild type, or low fold confidence.”
...
| Proto down | Track A+B only; no “new sequence” claim |
...
2. At least three Proto sequences that are not the fixture placeholders **or** an honest fixture banner
